...
export default function App() {
    ...
    return (<div style={{ padding: 24, fontFamily: "system-ui, sans-serif", maxWidth: 860 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginTop: 16 }}>
        ...
        <div style={{ border: "1px solid #333", borderRadius: 12, padding: 12 }}>
          ...
          <textarea rows={4} style={{ width: "100%", fontSize: 16 }} placeholder="Enter a Japanese sentence, e.g. 昨日 私は 買い物 行きました" value={userText} onChange={(e) => setUserText(e.target.value)}/>
      ...
      {(resultText || resultAudio) && (<div style={{ marginTop: 18, border: "1px solid #333", borderRadius: 12, padding: 12 }}>
